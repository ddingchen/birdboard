...
@section('content')
    <header class="flex items-center mb-3">
        <div class="mr-auto text-sm font-normal">
            <a href="/projects" class="text-default no-underline">My Projects</a> / {{ $project->title }}
        </div>
                ...
                <div class="mb-6">
                    ...
                    <form action="{{ $task->path() }}" method="post">
                        ...
                        <div class="card mb-3 flex">
                            <input type="text" name="body" class="bg-card text-default mr-auto w-full" value="{{ $task->body }}">
                    ...
                    <div class="card mb-3">
                        <form action="{{ $project->path() . '/tasks' }}" method="post">
                            @csrf
                            <input class="bg-card text-default w-full" type="text" name="body" placeholder="Add a task ...">
                        </form>
                    </div>
                </div>
